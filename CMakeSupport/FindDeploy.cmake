...
if( NOT DEFINED USE_QT OR USE_QT )
	...
	function(DeployQt target directory)
		...
		if ( NOT _INSTALL_ONLY )
			...
			IF( WIN32 )
				SET(_QTDEPLOY_OPTIONS_LCL "--verbose=1;${NO_DIST_OPTIONS};--pdb;${NO_TRANSLATIONS_OPT}" )
			ELSEIF( APPLE )
				SET(_QTDEPLOY_TARGET_DIR "$<TARGET_FILE:${target}>/../.." )
				SET(_QTDEPLOY_OPTIONS_LCL "--verbose=1;--always-overwrite;${NO_TRANSLATIONS_OPT}" )
			ELSEIF( UNIX )
		...
		if ( NOT _NON_INSTALL_ONLY )
			install(CODE
				...
				IF( WIN32 )
					SET(_QTDEPLOY_OPTIONS \"--dry-run;--list;mapping;${NO_DIST_OPTIONS};${NO_TRANSLATIONS_OPT}\" )
				ELSEIF( APPLE )
